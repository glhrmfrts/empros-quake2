...
void Com_VPrintf(int print_level, const char *fmt, va_list argptr);// __attribute__((format(printf, 1, 2)));
void Com_MDPrintf(char *fmt, ...);// __attribute__((format(printf, 1, 2)));
YQ2_ATTR_NORETURN void Com_Error(int code, char *fmt, ...);// __attribute__((format(printf, 1, 2)));
